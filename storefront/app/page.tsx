...
export default function Home() {
  ...
  const slides = [
    {
      title: 'Không gian sống thanh lịch',
      subtitle: 'Biến ngôi nhà của bạn thành không gian đẳng cấp với nội thất cao cấp',
      image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=1200&h=600&fit=crop'
    },
    {
      title: 'Bộ sưu tập phòng ngủ sang trọng',
      subtitle: 'Sự thoải mái gặp gỡ sự tinh tế',
      image: 'https://images.unsplash.com/photo-1616594039964-ae9021a400a0?w=1200&h=600&fit=crop'
    },
    {
      title: 'Bộ bàn ăn hiện đại',
      subtitle: 'Tạo những khoảnh khắc đáng nhớ',
    ...
    <div className="max-w-7xl mx-auto px-6">
      ...
      <section className="mb-20">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4">Sản phẩm nổi bật</h2>
          <p className="text-lg text-secondary">Khám phá bộ sưu tập được chọn lọc của chúng tôi</p>
        </div>
      ...
      <section className="mb-20">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4">Dịch vụ của chúng tôi</h2>
          <p className="text-lg text-secondary">Giải pháp thiết kế nội thất toàn diện</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl border border-gray-200 text-center hover:border-accent transition-colors cursor-pointer">
            ...
            <h3 className="text-2xl font-semibold mb-3">Thiết kế nội thất</h3>
            <p className="text-secondary">Tư vấn thiết kế chuyên nghiệp cho không gian của bạn</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl border border-gray-200 text-center hover:border-accent transition-colors cursor-pointer">
            ...
            <h3 className="text-2xl font-semibold mb-3">Nội thất tùy chỉnh</h3>
            <p className="text-secondary">Nội thất được thiết kế riêng theo nhu cầu của bạn</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-md p-8 rounded-2xl border border-gray-200 text-center hover:border-accent transition-colors cursor-pointer">
            ...
            <h3 className="text-2xl font-semibold mb-3">Giao hàng miễn phí</h3>
            <p className="text-secondary">Giao hàng nhanh chóng và an toàn đến ngôi nhà bạn</p>
          </div>
        </div>
      </section>
    </div>
